...
function mostrarTablaPotencial(x, y, decimal)
  ...
  uicontrol (f, "style", "text", "string", "X=ln(x)", "position",[220 altura 20 30]);
  ...
  for i = 1:(length(x)+1)
    ...
    uicontrol (f, "style", "text", "string", num2str(funcionRedondeo(log(x(i)), decimal)), "position",[220 (altura-i*50) 20 30]);
    uicontrol (f, "style", "text", "string", num2str(funcionRedondeo((log(x(i)))^2, decimal)), "position",[290 (altura-i*50) 20 30]);
    uicontrol (f, "style", "text", "string", num2str(funcionRedondeo(log(y(i)), decimal)), "position",[360 (altura-i*50) 20 30]);
    uicontrol (f, "style", "text", "string", num2str(funcionRedondeo(log(x(i))*log(y(i)), decimal)), "position",[430 (altura-i*50) 20 30]);
    if(i == (length(x)+1))
      ...
      uicontrol (f, "style", "text", "string", num2str(totalX), "position",[220 (altura-i*50) 20 30]);
      uicontrol (f, "style", "text", "string", num2str(totalXcuadrado), "position",[290 (altura-i*50) 20 30]);
      uicontrol (f, "style", "text", "string", num2str(totalY), "position",[360 (altura-i*50) 20 30]);
