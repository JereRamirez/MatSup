...
function mostrarTabla(boolLineal, boolParabola, boolExponencial, boolHiperbola, boolPotencial, x, y, decimal)
  ...
  if(boolLineal)
      uicontrol (f, "style", "text", "string", "Error Lineal", "position",[margen altura 100 30]);      
      for i = 1:length(x)        
      uicontrol (f, "style", "text", "string",num2str(erroresLineal(i)) , "position",[margen (altura-i*50) 80 30]);     
    endfor
    uicontrol (f, "style", "text", "string",num2str(sum(erroresLineal)) , "position",[margen (altura-(length(x)+1)*50) 80 30]);
    margen = margen + 120;
  endif
  
   if(boolParabola)
      uicontrol (f, "style", "text", "string", "Error Parabola", "position",[margen altura 100 30]);      
      for i = 1:length(x)        
      uicontrol (f, "style", "text", "string",num2str(erroresParabola(i)) , "position",[margen (altura-i*50) 80 30]);      
    endfor
    uicontrol (f, "style", "text", "string",num2str(sum(erroresParabola)) , "position",[margen (altura-(length(x)+1)*50) 80 30]);
    margen = margen + 120;
  endif
  
  if(boolExponencial)
      uicontrol (f, "style", "text", "string", "Error Exponencial", "position",[margen altura 100 30]);      
      for i = 1:length(x)        
      uicontrol (f, "style", "text", "string",num2str(erroresExponencial(i)) , "position",[margen (altura-i*50) 80 30]);      
    endfor
    uicontrol (f, "style", "text", "string",num2str(sum(erroresExponencial)) , "position",[margen (altura-(length(x)+1)*50) 80 30]);
    margen = margen + 120;
  endif  
 
  
  if(boolHiperbola)
      uicontrol (f, "style", "text", "string", "Error Hiperbola", "position",[margen altura 100 30]);      
      for i = 1:length(x)        
      uicontrol (f, "style", "text", "string",num2str(erroresHiperbola(i)) , "position",[margen (altura-i*50) 80 30]);      
    endfor
    uicontrol (f, "style", "text", "string",num2str(sum(erroresHiperbola)) , "position",[margen (altura-(length(x)+1)*50) 80 30]);
    margen = margen + 120;
  endif
  
   if(boolPotencial)
      uicontrol (f, "style", "text", "string", "Error Potencial", "position",[margen altura 100 30]);      
      for i = 1:length(x)        
      uicontrol (f, "style", "text", "string",num2str(erroresPotencial(i)) , "position",[margen (altura-i*50) 80 30]);      
    endfor
    uicontrol (f, "style", "text", "string",num2str(sum(erroresPotencial)) , "position",[margen (altura-(length(x)+1)*50) 80 30]);
    margen = margen + 120;
  endif
